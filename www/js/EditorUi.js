...
EditorUi.prototype.save = function(name)
{
	if (name != null)
	{
		...
		try
		{
			...
			{
				if (xml.length < MAX_REQUEST_SIZE||true)
				{
...
EditorUi.prototype.createDivs = function()
{
	...
	this.rightContainer = this.createDiv('rightContainer');
	//this.rightBar = this.createDiv('rightBar');
	this.diagramContainer = this.createDiv('geDiagramContainer');
	this.test = this.createDiv('test');
	...
	this.diagramContainer.style.right = '200px';
	this.footerContainer.style.left = '0px';
	this.footerContainer.style.right = '0px';
	this.footerContainer.style.bottom = '0px';
	this.vsplit.style.left = '0px';
	//this.rightBar.style.right='0px';
	//this.rightBar.style.wight='0px';
	//this.rightBar.style.float='right';
	//this.rightBar.style.position='relative';
...
EditorUi.prototype.createUi = function()
{
	...
	this.rightContainer.appendChild(this.diagramContainer);
	//this.rightContainer.appendChild(this.rightBar);
	...
	this.rightContainer.appendChild(this.diagramContainer);
	//$('<div style="float:right;;" id="listGraph"><ul id="listName"><li id="g_{id}" onclick="loadGraph(\'{id}\')">{name}</li></ul></div>').appendTo($('.geDiagramContainer'));
	//$('<div style="float:right;;" id="listGraph"><ul id="listName"><li id="g_{id}" onclick="loadGraph(\'{id}\')">{name}</li></ul></div>').appendTo($('.geDiagramContainer'));
	//this.container.appendChild($('<div style="float:left;">sdfasdf</div>').get(0));
	this.rightContainer.appendChild($('<div style="float:right;position:relative;top:70px;width:200px;" id="listGraph"><ul id="listName"><li style="list-style:none;" id="g_{id}" ondblclick="editGraph(\'{id}\')" onclick="loadGraph(\'{id}\')">{name}</li></ul></div>').get(0));

	//this.rightContainer.appendChild($('<div style="float:right;position:relative;top:70px;width:200px;" id="listGraph"><table class="tpl" id="listName"><tr style="list-style:none;" id="g_{id}" ondblclick="editGraph(\'{id}\')" onclick="loadGraph(\'{id}\')"><td>{name}</td></tr></table></div>').get(0));
